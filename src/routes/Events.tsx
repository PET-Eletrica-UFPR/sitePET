...
const activities = [
  {
    image: '/events/eventFeira.jpeg',
    title: <a href="https://www.instagram.com/ufpr_cursoseprofissoes/">FEIRA DE PROFISSÕES</a>,
  ...
  {
    image: '/events/seatel2022.png',
    title: <a href="https://www.instagram.com/seatelufpr/">Seatel</a>,
    summary: ['A SEATEL é a Semana de Atualização de Engenharia Elétrica. Ela é a semana acadêmica do curso de Engenharia Elétrica da Universidade Federal do Paraná (UFPR). Abrange os cursos diurno e noturno. Ocorre todos os anos.', 'Contém diversas atividades para ajudar os alunos a se aprimorarem nos conhecimentos, podendo ser de ajuda durante a graduação ou para um futuro trabalho na área. Para aqueles que já tem sua ênfase definida é uma chance de conhecer um pouco sobre as outras ênfases ou se aprofundar um pouco mais na sua.', <a href="https://www.instagram.com/seatelufpr/">Saiba mais na página do Instagram.</a>],
  },
  {
    image: '/events/eventsExpo.svg',
    title: <a href="http://www.eletrica.ufpr.br/pet/Expoeletrica.html">ExpoElétrica</a>,
